namespace Tvl.Java.DebugInterface.Client.Request
{
    ...
    internal sealed class MonitorContendedEnteredRequest : EventRequest, IMonitorContendedEnteredRequest
    {
        public MonitorContendedEnteredRequest(VirtualMachine virtualMachine)
            : base(virtualMachine)
        {
