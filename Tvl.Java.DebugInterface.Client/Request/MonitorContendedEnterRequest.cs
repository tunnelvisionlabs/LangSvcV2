namespace Tvl.Java.DebugInterface.Client.Request
{
    ...
    internal sealed class MonitorContendedEnterRequest : EventRequest, IMonitorContendedEnterRequest
    {
        public MonitorContendedEnterRequest(VirtualMachine virtualMachine)
            : base(virtualMachine)
        {
