namespace Tvl.Java.DebugInterface.Client.Request
{
    ...
    internal sealed class MethodEntryRequest : EventRequest, IMethodEntryRequest
    {
        public MethodEntryRequest(VirtualMachine virtualMachine)
            : base(virtualMachine)
        {
        ...
        internal override Types.EventKind EventKind
        {
            get
            {
                return Types.EventKind.MethodEntry;
            }
        }
