namespace Tvl.Java.DebugInterface.Request.Contracts
{
    ...
    [ContractClassFor(typeof(IMonitorContendedEnteredRequest))]
    internal abstract class IMonitorContendedEnteredRequestContracts : IMonitorContendedEnteredRequest
    {
