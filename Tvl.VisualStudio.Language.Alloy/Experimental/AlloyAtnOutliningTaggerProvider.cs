namespace Tvl.VisualStudio.Language.Alloy.Experimental
{
    ...
    public sealed class AlloyAtnOutliningTaggerProvider : ITaggerProvider
    {
        ...
        {
            Func<AlloyAtnOutliningTagger> creator = () => new AlloyAtnOutliningTagger(buffer, BackgroundIntelliSenseTaskScheduler, TextDocumentFactoryService, OutputWindowService);
