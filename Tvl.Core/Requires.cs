...
namespace Tvl
{
    ...
    public static class Requires
    {
        ...
        /// </summary>
        private static class PrivateErrorHelpers
        {
            /// <summary>
        ...
        {
            internal static readonly string Argument_EmptyArray = "'{0}' must contain at least one element.";
            internal static readonly string Argument_EmptyGuid = "'{0}' cannot be an empty guid.";
            internal static readonly string Argument_EmptyString = "'{0}' cannot be an empty string (\"\") or start with the null character.";
            internal static readonly string Argument_NullElement = "'{0}' cannot contain a null (Nothing in Visual Basic) element.";
            internal static readonly string Argument_Whitespace = "The parameter '{0}' cannot consist entirely of white space characters.";
        }
    }
}
