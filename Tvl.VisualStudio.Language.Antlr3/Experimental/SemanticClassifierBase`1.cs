namespace Tvl.VisualStudio.Language.Antlr3.Experimental
{
    ...
    public abstract class SemanticTaggerBase<TState> : ITagger<ISemanticTag>
        where TState : struct
    {
        ...
        public SemanticTaggerBase(ITextBuffer textBuffer)
            : this(textBuffer, EqualityComparer<TState>.Default)
        {
        }

        public SemanticTaggerBase(ITextBuffer textBuffer, IEqualityComparer<TState> stateComparer)
        {
