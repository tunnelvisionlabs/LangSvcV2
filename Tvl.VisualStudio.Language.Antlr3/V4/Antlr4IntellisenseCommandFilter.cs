namespace Tvl.VisualStudio.Language.AntlrV4
{
    ...
    internal class Antlr4IntellisenseCommandFilter : IntellisenseCommandFilter
    {
        ...
        internal new Antlr4IntellisenseController Controller
        {
            get
            {
                return (Antlr4IntellisenseController)base.Controller;
            }
        }
