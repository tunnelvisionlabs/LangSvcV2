namespace Tvl.VisualStudio.Language.Java.Debugger
{
    ...
    {
        public const int S_ATTACH_DEFERRED = 0x40004;
        public const int S_ATTACH_IGNORED = 0x40005;
        public const int S_JIT_USERCANCELLED = 0x400B0;
        public const int S_JIT_NOT_REG_FOR_ENGINE = 0x400B5;
        public const int S_TERMINATE_PROCESSES_STILL_DETACHING = 0x400C0;
        public const int S_TERMINATE_PROCESSES_STILL_TERMINATING = 0x400C1;
        public const int S_ENC_SETIP_REQUIRES_CONTINUE = 0x40106;
        public const int S_WEBDBG_UNABLE_TO_DIAGNOSE = 0x40120;
        public const int S_WEBDBG_DEBUG_VERB_BLOCKED = 0x40121;
        public const int S_ASP_USER_ACCESS_DENIED = 0x40125;
        public const int S_JMC_LIMITED_SUPPORT = 0x40146;
        public const int S_CANNOT_REMAP_IN_EXCEPTION = 0x40150;
        public const int S_CANNOT_REMAP_NOT_AT_SEQUENCE_POINT = 0x40151;
        public const int S_GETPARENT_NO_PARENT = 0x40531;
        public const int S_GETDERIVEDMOST_NO_DERIVED_MOST = 0x40541;
        public const int S_GETMEMORYBYTES_NO_MEMORY_BYTES = 0x40551;
        public const int S_GETMEMORYCONTEXT_NO_MEMORY_CONTEXT = 0x40561;
        public const int S_GETSIZE_NO_SIZE = 0x40571;
        public const int S_GETEXTENDEDINFO_NO_EXTENDEDINFO = 0x40591;
        ...
        public const int E_FAILED_TO_INITIALIZE_SCRIPT_PROXY = unchecked((int)0x8004001B);
        ...
        public const int E_INTEROP_CLR_TOO_OLD = unchecked((int)0x80040032);
        ...
        public const int E_JIT_RUNTIME_VERSION_UNSUPPORTED = unchecked((int)0x800400B6);
        ...
        public const int E_ASYNCBREAK_UNABLE_TO_PROCESS = unchecked((int)0x80040112);
        ...
        public const int E_REMOTE_PROCESS_OBJECT_ACCESS_DENIED = unchecked((int)0x8004013A);
        public const int E_REMOTE_ATTACH_REQUIRES_ELEVATION = unchecked((int)0x8004013B);
        public const int E_REMOTE_LAUNCH_ELEVATION_REQUIRED = unchecked((int)0x8004013C);
        ...
        public const int E_INTEROP_X64 = unchecked((int)0x80040225);
        public const int E_CRASHDUMP_DEPRECATED = unchecked((int)0x80040227);
        public const int E_LAUNCH_MANAGEDONLYMINIDUMP_UNSUPPORTED = unchecked((int)0x80040228);
        public const int E_LAUNCH_64BIT_MANAGEDMINIDUMP_UNSUPPORTED = unchecked((int)0x80040229);
        ...
        public const int E_KERBEROS_ACCESS_DENIED_ON_CALLBACK = unchecked((int)0x800405AA);
        public const int E_DNS_FAILURE_ON_CALLBACK = unchecked((int)0x800405AB);
        ...
        public const int E_HTTP_SITE_NOT_FOUND = unchecked((int)0x8004070C);
        public const int E_HTTP_APP_NOT_FOUND = unchecked((int)0x8004070D);
        public const int E_HTTP_MANAGEMENT_API_MISSING = unchecked((int)0x8004070E);
        public const int E_HTTP_NO_PROCESS = unchecked((int)0x8004070F);
        ...
        public const int E_REMOTE_PACKET_TOO_BIG = unchecked((int)0x80040761);
        public const int E_UNSUPPORTED_FUTURE_CLR_VERSION = unchecked((int)0x80040762);
        public const int E_UNSUPPORTED_CLR_V1 = unchecked((int)0x80040763);
        public const int E_INTEROP_IA64 = unchecked((int)0x80040764);
        public const int E_HTTP_GENERAL = unchecked((int)0x80040765);
        ...
        public const int E_OS_PERSONAL = unchecked((int)0x80040C00);
        public const int E_SOURCE_SERVER_DISABLE_PARTIAL_TRUST = unchecked((int)0x80040C01);
        public const int E_TRACE_DETACH_UNSUPPORTED = unchecked((int)0x80040D00);
        public const int E_THREAD_NOT_FOUND = unchecked((int)0x80040D01);
        public const int E_CANNOT_AUTOATTACH_TO_SQLSERVER = unchecked((int)0x80040D02);
        public const int E_OBJECT_OUT_OF_SYNC = unchecked((int)0x80040D03);

        public static class ExtendedPropertyInfoGuids
        {
            /// <summary>
            /// Returns an IUnknown interface to the document. Typically, the IDebugDocumentText2 interface can be obtained from this IUnknown interface.
            /// </summary>
            public static readonly Guid Document;

            /// <summary>
            /// Returns an IUnknown interface to the document context. Typically, the IDebugDocumentContext2 interface can be obtained from this IUnknown interface.
            /// </summary>
            public static readonly Guid CodeContext;

            /// <summary>
            /// Returns a string containing the CLSID of a custom viewer, typically implemented by an expression evaluator.
            /// </summary>
            public static readonly Guid CustomViewerSupported;

            /// <summary>
            /// Returns a 32-bit number representing the desired slot number if this property represents a managed code local address.
            /// </summary>
            public static readonly Guid ExtendedInfoSlot;

            /// <summary>
            /// Returns a string containing the signature of the variable associated with the property object.
            /// </summary>
            public static readonly Guid ExtendedInfoSignature;
        }
    }
}
